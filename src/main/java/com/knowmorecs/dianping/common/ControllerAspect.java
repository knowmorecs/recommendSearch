    package com.knowmorecs.dianping.common;

    import com.knowmorecs.dianping.controller.admin.AdminController;
    ...
    public class ControllerAspect {
        ...
        @Around("execution(* com.knowmorecs.dianping.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
